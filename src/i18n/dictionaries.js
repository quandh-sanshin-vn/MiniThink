export const dictionaries = {
  vi: {
    ...
    'timer.long_break_warn': 'Bạn đã hoàn thành 5 phiên làm việc. Đây là lúc bắt buộc phải có một kỳ nghỉ dài!',
  ...
  en: {
    ...
    'timer.long_break_warn': 'You have completed 5 sessions. It is mandatory to take a long break now!',
  ...
  ja: {
    ...
    'timer.long_break_warn': '5回のセッションを完了しました。ここで必ず長い休憩を取る必要があります！',
